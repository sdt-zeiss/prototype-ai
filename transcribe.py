...
def transcribe(audio_file, audio_extension, audio_url=""):
    ...
    vectordb = add_data(df[['text', 'speaker']], connection_string, PGVECTOR_COLLECTION, pre_delete_collection=False)

    print('transcription and export done')
